...
var LuckRightChoose
var StartScreenTouchBlock = false
...
#	print(CardText)
#	print(CardName)
#	$Control/IventOfCard/VBoxContainer/CardText.text = MainScene.CardText
#	$Control/IventOfCard/VBoxContainer/CharacterName.text = MainScene.CardName
