...
const DATA = {
	...
	Tutorial1 : 
		...
		"Я знаю как играть", #Ответ на лево 4 (НЕТ)
		"Хорошо, объясняй дальше", #ответ на право 5 (ДА)
		...
		"Tutorial2", #Следующая карта на лево 14 (НЕТ)
	...
	Random14 : 
		...
		"Чтобы ты нас обосрал? Ну уж нет!", #Ответ на лево
		"Сейчас откроем вам счет", #ответ на право
		+10, #Ренессанс на лево 6
		-20, #Люди на лево 7
		0, #ЦБ на лево 8
		0, #Деньги на лево 9
